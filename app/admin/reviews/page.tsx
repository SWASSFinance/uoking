  ...
  const handleReviewAction = async (reviewId: string, action: 'approve' | 'reject') => {
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: "Error",
          description: error.error || `Failed to ${action} review`,
          variant: "destructive",
        })
      }
    } catch (error) {
      ...
      <main className="py-8 px-4">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Manage and approve customer product reviews</p>
          </div>
                  ...
                  {filteredReviews.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600">
                        {activeTab === 'pending' && "No pending reviews to approve"}
                              ...
                              <div className="flex items-start justify-between mb-3">
                                <div>
                                  <h3 className="font-semibold text-gray-900 mb-1">
                                    <Link href={`/product/${review.product_id}`} className="hover:text-blue-600">
                                      {review.product_name}
                                    </Link>
                                  </h3>
