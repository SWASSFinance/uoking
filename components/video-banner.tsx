...
export function VideoBanner({ banners }: VideoBannerProps) {
  ...
  useEffect(() => {
    ...
    window.addEventListener('muteVideo', handleMuteVideo)
    window.addEventListener('unmuteVideo', handleUnmuteVideo)
    
    return () => {
      window.removeEventListener('muteVideo', handleMuteVideo)
      window.removeEventListener('unmuteVideo', handleUnmuteVideo)
    }
  }, [])
