...
export function PremiumBenefitsAd({ 
  ...
  if (variant === 'banner') {
    return (
      <div className={`bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/50 dark:to-pink-900/50 border border-purple-200 dark:border-purple-700 rounded-lg p-4 ${className}`}>
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Get exclusive discounts and benefits</p>
            </div>
          </div>
