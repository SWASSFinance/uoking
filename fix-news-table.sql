...
('1', 'The launch!', 'It is a proud day for us at UO King.  We are now live and accepting orders!', 'admin', '2018-02-25'),
('2', 'Guild Sponsoring & The No Dupe Alliance', 'Today marks another tremendous day for uo king and the ultima community.  I am thrilled to announce that we will begin sponsoring guilds every month based on a few factors like activeness, stability, and good attitute! Every month we will be giving away free gold and items to all sponsored guilds. 
...
('3', '100 MIL GIVEAWAY', '<img src="/images/contest.png" alt="UO Contest"><BR>
<b>RULES:</b><BR>
...
('4', 'UO Publish 99, Stygian Abyss - New players', 'Updated April 1st:
...
('5', 'New Idoc System', 'Due to unreliability of the previous idoc finder I have developed a new one which is much more accurate and has 24/7 uptime.  I still have not released the zoom-able mapping yet but it will be shorty!
...
('25', 'Summer is here!', 'Getting back into UO this summer? We got you covered from suits, full characters, mounts, houses, gear, weapons, resources. You name, we have it and at competitive cheap UO gold prices. Live chat us with any questions and if you do not see a live chat at the bottom of page you may need to allow popups from uoking.com.', 'admin', '2023-07-10'),
('26', '2024 New items, deals, and more.', 'UO King will be as active, as ever in 2024.  We are planning a huge roll out of new features and development  Just want to thank all the loyal customers over the years who stuck with us!  THANK YOU! HAPPY NEW YEAR!.  ', 'admin', '2024-01-14'),
('27', 'UO King is back and open for business!', 'Newly staffed and ready to fulfill all customer needs in 2024!', 'admin', '2024-05-02'),
('28', 'Join the Hunt for Ellendur''s Lost Loot - Tomorrow at 8 PM EST!', 'Greetings Adventurers of Britannia,
...
('29', 'Merry Christmas From UO King!', 'Happy holidays, please enjoy our current coupon coded: fiveoff 
...
('30', 'Still here, still delivering!', 'Ring our live chat for fast service.', 'admin', '2025-08-11');
